...
cdef extern from "azure_uamqp_c/link.h":
    ...
    int link_set_offered_capabilities(LINK_HANDLE link, c_amqpvalue.AMQP_VALUE offered_capabilities)
    int link_get_offered_capabilities(LINK_HANDLE link, c_amqpvalue.AMQP_VALUE* offered_capabilities)
