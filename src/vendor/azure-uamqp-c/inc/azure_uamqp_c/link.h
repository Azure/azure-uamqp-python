...
MOCKABLE_FUNCTION(, int, link_set_offered_capabilities, LINK_HANDLE, link, AMQP_VALUE, offered_capabilities);
MOCKABLE_FUNCTION(, int, link_get_offered_capabilities, LINK_HANDLE, link, AMQP_VALUE*, offered_capabilities);
