...
if _CAN_ADD_DOCSTRING:
    OpenFrame.__doc__ = """OPEN performative. Negotiate Connection parameters.
...
if _CAN_ADD_DOCSTRING:
    BeginFrame.__doc__ = """BEGIN performative. Begin a Session on a channel.
...
if _CAN_ADD_DOCSTRING:
    AttachFrame.__doc__ = """ATTACH performative. Attach a Link to a Session.
...
if _CAN_ADD_DOCSTRING:
    FlowFrame.__doc__ = """FLOW performative. Update link state.
...
if _CAN_ADD_DOCSTRING:
    DispositionFrame.__doc__ = """DISPOSITION performative. Inform remote peer of delivery state changes.
...
if _CAN_ADD_DOCSTRING:
    DetachFrame.__doc__ = """DETACH performative. Detach the Link Endpoint from the Session.
...
if _CAN_ADD_DOCSTRING:
    EndFrame.__doc__ = """END performative. End the Session.
...
if _CAN_ADD_DOCSTRING:
    CloseFrame.__doc__ = """CLOSE performative. Signal a Connection close.
...
if _CAN_ADD_DOCSTRING:
    SASLMechanism.__doc__ = """Advertise available sasl mechanisms.
...
if _CAN_ADD_DOCSTRING:
    SASLInit.__doc__ = """Initiate sasl exchange.
...
if _CAN_ADD_DOCSTRING:
    SASLChallenge.__doc__ = """Security mechanism challenge.
...
if _CAN_ADD_DOCSTRING:
    SASLResponse.__doc__ = """Security mechanism response.
...
if _CAN_ADD_DOCSTRING:
    SASLOutcome.__doc__ = """Indicates the outcome of the sasl dialog.
