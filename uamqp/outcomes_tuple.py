...
from .performatives_tuple import _CAN_ADD_DOCSTRING


Received = namedtuple('received', ['section_number', 'section_offset'])
if _CAN_ADD_DOCSTRING:
    Received.__doc__ = """At the target the received state indicates the furthest point in the payload of the message
...
if _CAN_ADD_DOCSTRING:
    Accepted.__doc__ = """The accepted outcome.
...
if _CAN_ADD_DOCSTRING:
    Rejected.__doc__ = """The rejected outcome.
...
if _CAN_ADD_DOCSTRING:
    Released.__doc__ = """The released outcome.
...
if _CAN_ADD_DOCSTRING:
    Modified.__doc__ = """The modiﬁed outcome.
